...
export default function Authentication({ children }: AuthenticationProps) {
  return (
    <div className="fixed left-0 top-0 z-40 flex h-full w-screen flex-col items-center justify-center overflow-y-auto bg-gradient-to-b from-primaryGradientStart to-primaryGradientEnd md:grid lg:grid-cols-2 lg:px-0">
      ...
      <div className="flex h-full w-full items-center justify-center bg-transparent p-0 lg:relative lg:bg-foreground lg:dark:bg-background">
        <div className="absolute right-0 top-0 flex w-full items-center justify-between  py-3  sm:top-4 sm:bg-transparent sm:py-0 sm:dark:bg-transparent ">
