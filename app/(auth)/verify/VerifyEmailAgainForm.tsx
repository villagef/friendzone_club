...
import { handleSendEmail, handleUpdateVarifyToken } from "@/lib/utils"
  ...
  async function onSubmit() {
    try {
      if (!recaptchaToken && !email) {
        ...
        const resToken = await handleUpdateVarifyToken(email!, token)
        const resEmail = await handleSendEmail(email!, token)
