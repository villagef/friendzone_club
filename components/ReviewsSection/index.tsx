...
interface ReviewsSectionProps {
  content: DictionaryType["page"]["home"]["reviews"]
}
  ...
  return (
    <div className="container flex max-w-screen-2xl flex-col items-center justify-center">
      ...
      <div className="flex w-full flex-wrap items-center justify-center gap-10 md:gap-16">
        {content.reviews.map(({ name, status, rating, review, avatar }) => (
          <div
            key={name}
          ...
          >
            ...
            <div>
              <div className="mt-4 flex items-center">
                ...
                <p className="ml-2 text-sm font-medium ">{rating} / 5</p>
              </div>
            </div>
            <p className="pt-4 text-center tracking-wider">{review}</p>
          </div>
        ))}
      </div>
    </div>
