...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium text-primary transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-background text-secondary shadow hover:bg-accent",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-input bg-transparent font-bold text-secondary shadow-sm hover:bg-accent hover:text-button dark:text-primary",
        primary:
          "bg-button font-bold text-secondary shadow hover:bg-secondary hover:text-button ",
        secondary:
